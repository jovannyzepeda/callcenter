...
class TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create template" do
    assert_difference('Template.count') do
      post templates_url, params: { template: { company_id: @template.company_id, lenguaje: @template.lenguaje } }
    end
  ...
  test "should update template" do
    patch template_url(@template), params: { template: { company_id: @template.company_id, lenguaje: @template.lenguaje } }
